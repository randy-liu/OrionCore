...
namespace OrionCore.API.Extensions
{
	...
	public static class QueryableExtensions
	{
		...
		public static IOrderedQueryable<TSource> AdvancedOrderBy<TSource>(this IQueryable<TSource> source, string keySelector)
		{
			...
			MethodInfo orderByMethod = Utils.QueryableOrderByMethod(modelType, first.Prop.PropertyType);
			var firstExpression = Utils.KeyExpression(modelType, first.Prop);

			var ordered = (IOrderedQueryable<TSource>)orderByMethod.Invoke(null, new object[] { source, firstExpression, first.Descending });
