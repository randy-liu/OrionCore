...
namespace Orion.Api.Models.Tests
{
	public class WhereParamsTests
	{
		...
		public void Assing_Test1()
		{
			...
			Assert.NotEmpty(param.GetValues(x => x.InvoicePrefix));
		...
		public void Assing_Test2()
		{
			...
			Assert.NotEmpty(param.GetValues(x => x.Sum));
		...
		public void Assing_Test3()
		{
			...
			Assert.NotEmpty(param.GetValues(x => x.UseStatus));
		...
		public void Assing_Test10()
		{
			...
			Assert.Single(param.GetValues(x => x.InvoicePrefix));
